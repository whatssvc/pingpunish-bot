...
MOD_ROLE_ID = 1391654796989169707  # Change if needed
...
current_count = {}         # guild_id -> current number
cooldowns = defaultdict(lambda: defaultdict(float))  # guild_id -> user_id -> cooldown_end
